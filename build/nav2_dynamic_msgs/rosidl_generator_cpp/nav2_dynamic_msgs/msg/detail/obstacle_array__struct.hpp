...
struct ObstacleArray_
{
  ...
  using _obstacles_type =
    std::vector<nav2_dynamic_msgs::msg::Obstacle_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_dynamic_msgs::msg::Obstacle_<ContainerAllocator>>>;
  ...
  Type & set__obstacles(
    const std::vector<nav2_dynamic_msgs::msg::Obstacle_<ContainerAllocator>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<nav2_dynamic_msgs::msg::Obstacle_<ContainerAllocator>>> & _arg)
  {
    this->obstacles = _arg;
    return *this;
  }
