...
{
  const auto & item = *reinterpret_cast<const nav2_dynamic_msgs::msg::Obstacle *>(
    get_const_function__ObstacleArray__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<nav2_dynamic_msgs::msg::Obstacle *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<nav2_dynamic_msgs::msg::Obstacle *>(
    get_function__ObstacleArray__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const nav2_dynamic_msgs::msg::Obstacle *>(untyped_value);
  item = value;
}
